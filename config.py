...
class Config:
    def init(self, args):
        ...
        # ================== DATASET
        self.DATA_FILE = root.joinpath(root.parents[0],'data/').as_posix() + '/' + dataset.DATASET + '-train'
        self.DATA_VAL_FILE  = root.joinpath(root.parents[0],'data/').as_posix() + '/' + dataset.DATASET + '-val'
        self.DATA_TEST_FILE = root.joinpath(root.parents[0],'data/').as_posix() + '/' + dataset.DATASET + '-test'
        self.META_FILE = root.joinpath(root.parents[0],'data/').as_posix() + '/' + dataset.DATASET + '-meta'
        self.HPC_FILE = root.joinpath(root.parents[0],'data/').as_posix() + '/' + dataset.DATASET + '-hpc'
